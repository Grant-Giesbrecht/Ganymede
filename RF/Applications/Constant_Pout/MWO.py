...
def printOptVars(awrde, indent="", rel_indent="  "):
	...
	for idx in range(1, awrde.Project.Optimizer.Variables.Count + 1):
		...
		print(f"{indent}{rel_indent}Enabled: {awrde.Project.Optimizer.Variables.Item(idx).Enabled}")
		print(f"{indent}{rel_indent}Constrained: {awrde.Project.Optimizer.Variables.Item(idx).Constrained}")
		print(f"{indent}{rel_indent}Maximum: {awrde.Project.Optimizer.Variables.Item(idx).Maximum}")
		print(f"{indent}{rel_indent}Minimum: {awrde.Project.Optimizer.Variables.Item(idx).Minimum}")
		print(f"{indent}{rel_indent}Nominal: {awrde.Project.Optimizer.Variables.Item(idx).Nominal}")
		print(f"{indent}{rel_indent}Step: {awrde.Project.Optimizer.Variables.Item(idx).Step}")
